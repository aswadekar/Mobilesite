...
<body>
    ...
    <div class="container">
        <div class="row">
        	<br />
        	<h2 align="center" style="font-family: 'Zen Dots', cursive; color: #000; font-weight: 600; font-size: 40px;">Mobile Recommendation Website</h2>
        	<br />
            <div class="col-md-3">                				
				<div class="list-group">
					<h3>Price</h3>
					<input type="hidden" id="hidden_minimum_price" value="0" />
                    <input type="hidden" id="hidden_maximum_price" value="130000" />
                    <p id="price_show">1000 - 130000</p>
